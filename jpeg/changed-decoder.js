    ...
    constructor.prototype = {
      ...
      parse: function parse(data) {
        ...
        function prepareComponents(frame) {
          ...
          let blocksPerLine, blocksPerColumn, blocksPerLineForMcu, blocksPerColumnForMcu, blocks, i, row, j;
  
          for (componentId in frame.components) {
            if (frame.components.hasOwnProperty(componentId)) {
              component = frame.components[componentId];
              blocksPerLine = Math.ceil(Math.ceil(frame.samplesPerLine / 8) * component.h / maxH);
              blocksPerColumn = Math.ceil(Math.ceil(frame.scanLines  / 8) * component.v / maxV);
        ...
        while (fileMarker != 0xFFD9) { // EOI (End of image)
          ...
          switch(fileMarker) {
            ...
            case 0xFFDB: // DQT (Define Quantization Tables)
              ...
              let quantizationTableSpec, tableData, z;
            ...
            case 0xFFC4: // DHT (Define Huffman Tables)
              ...
              let huffmanTableSpec, codeLengths, codeLengthSum, huffmanValues;
